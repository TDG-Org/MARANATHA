// GENERATED by tools/import-home-design.mjs from the Claude Design project's
...
export const BACKDROP_HTML = `      <div data-sky="1" style="position:absolute; inset:0; background:linear-gradient(180deg,#01020a 0%,#03071a 13%,#061031 26%,#0a1842 39%,#102150 52%,#17284f 63%,#1d2b4a 73%,#222c42 84%,#242a38 94%)"></div>
      ...
      <div data-lum="1" style="position:absolute; left:1200px; top:414px; width:128px; height:128px; transform:translate(-50%,-50%); border-radius:50%; background:radial-gradient(circle at 38% 34%,#ffffff 0%,#f7faff 44%,#dfe8ff 62%,rgba(223,232,255,.3) 71%,rgba(223,232,255,0) 79%); animation:mrGlow 10s ease-in-out infinite; pointer-events:none; overflow:hidden">
        <div style="position:absolute; left:22%; top:26%; width:34%; height:30%; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(176,196,236,.16) 0%,rgba(176,196,236,0.088) 46%,rgba(176,196,236,0) 72%)"></div>
        <div style="position:absolute; left:52%; top:46%; width:26%; height:24%; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(176,196,236,.13) 0%,rgba(176,196,236,0.072) 46%,rgba(176,196,236,0) 72%)"></div>
        <div style="position:absolute; left:34%; top:62%; width:20%; height:16%; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(176,196,236,.1) 0%,rgba(176,196,236,0.055) 46%,rgba(176,196,236,0) 72%)"></div>
        <div style="position:absolute; left:60%; top:22%; width:12%; height:11%; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(176,196,236,.12) 0%,rgba(176,196,236,0.066) 46%,rgba(176,196,236,0) 72%)"></div>
      </div>

      <div data-band="0" data-par="0.04" style="position:absolute; left:0; top:326px; width:6400px; height:210px; pointer-events:none">
        <div style="position:absolute; left:85px; top:5px; width:590px; height:154px; opacity:0.250; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 96s ease-in-out 0s infinite alternate"></div>
        <div style="position:absolute; left:734px; top:70px; width:432px; height:114px; opacity:0.175; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 118s ease-in-out 3s infinite alternate"></div>
        <div style="position:absolute; left:1140px; top:-10px; width:700px; height:176px; opacity:0.138; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 104s ease-in-out 6s infinite alternate"></div>
        <div style="position:absolute; left:2050px; top:54px; width:520px; height:132px; opacity:0.225; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 92s ease-in-out 2s infinite alternate"></div>
        <div style="position:absolute; left:2823px; top:-1px; width:614px; height:162px; opacity:0.188; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 126s ease-in-out 8s infinite alternate"></div>
        <div style="position:absolute; left:3693px; top:65px; width:454px; height:118px; opacity:0.163; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 110s ease-in-out 4s infinite alternate"></div>
        <div style="position:absolute; left:4422px; top:6px; width:656px; height:166px; opacity:0.213; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 98s ease-in-out 7s infinite alternate"></div>
        <div style="position:absolute; left:5291px; top:59px; width:498px; height:128px; opacity:0.150; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 122s ease-in-out 1s infinite alternate"></div>
        <div style="position:absolute; left:5906px; top:4px; width:568px; height:150px; opacity:0.200; border-radius:50%; background:radial-gradient(ellipse at 50% 50%,rgba(196,218,255,.40) 0%,rgba(196,218,255,.26) 34%,rgba(196,218,255,.10) 58%,rgba(196,218,255,0) 78%); animation:mrDrift 106s ease-in-out 5s infinite alternate"></div>
      </div>

      <div data-band="1" data-par="0.05" style="position:absolute; left:0; top:0; width:6400px; height:810px; color:#080f24; pointer-events:none">
        <svg viewBox="0 0 6400 810" preserveAspectRatio="none" style="position:absolute; left:0; top:0; width:6400px; height:810px">
          ...
          <path data-crossshadow="1" d="M1155 469 L1161 469 L1165 497 L1151 497 Z M1148 478 L1168 478 L1173 483 L1143 483 Z" fill="#0a122a" opacity="0.4"></path>
          <path data-crossshadow="1" d="M1239 464 L1245 464 L1249 492 L1235 492 Z M1232 473 L1252 473 L1257 478 L1227 478 Z" fill="#0a122a" opacity="0.4"></path>
          <path data-crossshadow="1" d="M1197 465 L1203 465 L1213 519 L1187 519 Z M1179 481 L1221 481 L1226 491 L1174 491 Z" fill="#0a122a" opacity="0.55"></path>
        ...
        <div style="position:absolute; left:820px; top:483px; width:7px; height:34px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; bottom:2.4px; width:7px; height:31.6px; background:currentColor; border-radius:3.5px 3.5px 2px 2px / 19.7px 19.7px 3.4px 3.4px"></div>
        ...
        <div style="position:absolute; left:842px; top:491px; width:5px; height:24px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; bottom:1.7px; width:5px; height:22.3px; background:currentColor; border-radius:2.5px 2.5px 1.4px 1.4px / 13.9px 13.9px 2.4px 2.4px"></div>
        ...
        <div style="position:absolute; left:2460px; top:461px; width:9px; height:28px; background:currentColor; transform-origin:bottom center;  clip-path:polygon(50% 0%,58% 13%,52.5% 13%,64% 29%,57% 29%,70.5% 47%,61% 47%,77% 67%,64% 67%,83% 88%,55.5% 88%,55.5% 100%,44.5% 100%,44.5% 88%,17% 88%,36% 67%,23% 67%,39% 47%,29.5% 47%,43% 29%,36% 29%,47.5% 13%,42% 13%)"></div>
        <div style="position:absolute; left:3980px; top:433px; width:6px; height:26px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; bottom:1.8px; width:6px; height:24.2px; background:currentColor; border-radius:3px 3px 1.7px 1.7px / 15.1px 15.1px 2.6px 2.6px"></div>
        ...
        <div data-campgroup="1" style="position:absolute; left:596px; top:455px; width:222px; height:111px">
          <div data-fire="1" data-firepool="1" style="position:absolute; left:44px; top:71px; width:141px; height:34px; border-radius:50%; background:radial-gradient(ellipse at center,rgba(255,168,84,.5) 0%,rgba(255,140,60,.2) 42%,rgba(255,130,50,0) 74%); animation:mrShimmer 3.0s ease-in-out 0s infinite"></div>
          <div data-fire="1" style="position:absolute; left:71px; top:28px; width:89px; height:89px; transform:translate(-50%,-50%) translate(44px,44px); border-radius:50%; background:radial-gradient(circle,rgba(255,182,96,.52) 0%,rgba(255,150,64,.18) 38%,rgba(255,140,56,0) 70%); animation:mrShimmer 2.4s ease-in-out 0s infinite"></div>
      ...
      <div data-band="2" data-par="0.10" style="position:absolute; left:0; top:0; width:6400px; height:810px; color:#04081a; pointer-events:none">
        <svg viewBox="0 0 6400 810" preserveAspectRatio="none" style="position:absolute; left:0; top:0; width:6400px; height:810px">
        ...
        <div style="position:absolute; left:326px; top:565px; width:9px; height:42px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; top:0; width:26px; height:23px; transform-origin:bottom center; ">
        ...
        <div style="position:absolute; left:2362px; top:554px; width:10px; height:46px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; top:0; width:22px; height:19.2px; transform-origin:bottom center; ">
        ...
        <div style="position:absolute; left:4304px; top:547px; width:8px; height:34px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; top:0; width:24px; height:21.8px; transform-origin:bottom center; ">
        ...
        <div style="position:absolute; left:6100px; top:564px; width:9px; height:40px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; bottom:2.8px; width:9px; height:37.2px; background:currentColor; border-radius:4.5px 4.5px 2.5px 2.5px / 23.2px 23.2px 4px 4px"></div>
        ...
        <div style="position:absolute; left:5400px; top:578px; width:26px; height:16px; transform-origin:bottom center; ">
      ...
      <div data-band="3" data-par="0.17" style="position:absolute; left:0; top:0; width:6400px; height:810px; color:#01030c; pointer-events:none">
        <svg viewBox="0 0 6400 810" preserveAspectRatio="none" style="position:absolute; left:0; top:0; width:6400px; height:810px">
        ...
        <div style="position:absolute; left:338px; top:584px; width:16px; height:80px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; top:0; width:42px; height:37.1px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; top:0; width:28px; height:25.6px; transform-origin:bottom center; ">
        ...
        <div style="position:absolute; left:1500px; top:623px; width:44px; height:72px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:20px; bottom:61.9px; width:10.6px; height:2px; background:currentColor; transform:rotate(-30deg); transform-origin:left bottom"></div>
        ...
        <div style="position:absolute; left:1946px; top:603px; width:18px; height:88px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; bottom:6.2px; width:18px; height:81.8px; background:currentColor; border-radius:9px 9px 5px 5px / 51px 51px 8.8px 8.8px"></div>
        ...
        <div style="position:absolute; left:2320px; top:630px; width:42px; height:62px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:17.2px; top:9.9px; width:7.6px; height:5px; border-radius:50%; background:currentColor"></div>
        ...
        <div style="position:absolute; left:3104px; top:630px; width:10px; height:44px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; top:0; width:44px; height:39.7px; transform-origin:bottom center; ">
        ...
        <div style="position:absolute; left:3860px; top:595px; width:48px; height:80px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:22px; bottom:68.8px; width:11.5px; height:2px; background:currentColor; transform:rotate(-30deg); transform-origin:left bottom"></div>
        ...
        <div style="position:absolute; left:4286px; top:610px; width:17px; height:82px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; bottom:5.7px; width:17px; height:76.3px; background:currentColor; border-radius:8.5px 8.5px 4.8px 4.8px / 47.6px 47.6px 8.2px 8.2px"></div>
        ...
        <div style="position:absolute; left:4640px; top:645px; width:38px; height:56px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:15.6px; top:9px; width:6.8px; height:4.5px; border-radius:50%; background:currentColor"></div>
        ...
        <div style="position:absolute; left:5440px; top:624px; width:42px; height:68px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:19px; bottom:58.5px; width:10.1px; height:2px; background:currentColor; transform:rotate(-30deg); transform-origin:left bottom"></div>
        ...
        <div style="position:absolute; left:5864px; top:606px; width:17px; height:84px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:0; top:0; width:38px; height:34.6px; transform-origin:bottom center; ">
        ...
        <div style="position:absolute; left:1300px; top:673px; width:38px; height:24px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:23.6px; bottom:0; width:14.4px; height:16.8px; border-radius:50% 50% 40% 40%; background:currentColor"></div>
        ...
        <div style="position:absolute; left:2900px; top:658px; width:34px; height:22px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:21.1px; bottom:0; width:12.9px; height:15.4px; border-radius:50% 50% 40% 40%; background:currentColor"></div>
        ...
        <div style="position:absolute; left:4460px; top:679px; width:32px; height:20px; transform-origin:bottom center; ">
      ...
      <div style="position:absolute; left:19.8px; bottom:0; width:12.2px; height:14px; border-radius:50% 50% 40% 40%; background:currentColor"></div>
        ...
        <div style="position:absolute; left:6000px; top:665px; width:36px; height:23px; transform-origin:bottom center; ">
      ...
      <div style="width:3px; height:11.2px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:16px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:8.8px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:13.6px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div>
    </div>
        <div style="position:absolute; left:2500px; top:680px; display:flex; align-items:flex-end; gap:4px">
      <div style="width:3px; height:9.8px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:14px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:7.7px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:11.9px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div>
    </div>
        <div style="position:absolute; left:4000px; top:665px; display:flex; align-items:flex-end; gap:4px">
      <div style="width:3px; height:11.9px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:17px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:9.4px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:14.4px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div>
    </div>
        <div style="position:absolute; left:5600px; top:675px; display:flex; align-items:flex-end; gap:4px">
      <div style="width:3px; height:10.5px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:15px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:8.3px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div><div style="width:3px; height:12.8px; background:currentColor; border-radius:3px; transform-origin:bottom; "></div>
    </div>
        <div data-campgroup="1" style="position:absolute; left:2140px; top:591px; width:285px; height:143px">
          <div data-fire="1" data-firepool="1" style="position:absolute; left:57px; top:91px; width:181px; height:44px; border-radius:50%; background:radial-gradient(ellipse at center,rgba(255,168,84,.5) 0%,rgba(255,140,60,.2) 42%,rgba(255,130,50,0) 74%); animation:mrShimmer 3.4s ease-in-out 0.5s infinite"></div>
          <div data-fire="1" style="position:absolute; left:91px; top:36px; width:114px; height:114px; transform:translate(-50%,-50%) translate(57px,57px); border-radius:50%; background:radial-gradient(circle,rgba(255,182,96,.52) 0%,rgba(255,150,64,.18) 38%,rgba(255,140,56,0) 70%); animation:mrShimmer 2.7s ease-in-out 0.3s infinite"></div>
        ...
        <div data-campgroup="1" style="position:absolute; left:4460px; top:612px; width:255px; height:128px">
          <div data-fire="1" data-firepool="1" style="position:absolute; left:51px; top:82px; width:162px; height:39px; border-radius:50%; background:radial-gradient(ellipse at center,rgba(255,168,84,.5) 0%,rgba(255,140,60,.2) 42%,rgba(255,130,50,0) 74%); animation:mrShimmer 3.8s ease-in-out 1.0s infinite"></div>
          <div data-fire="1" style="position:absolute; left:82px; top:32px; width:102px; height:102px; transform:translate(-50%,-50%) translate(51px,51px); border-radius:50%; background:radial-gradient(circle,rgba(255,182,96,.52) 0%,rgba(255,150,64,.18) 38%,rgba(255,140,56,0) 70%); animation:mrShimmer 3.0s ease-in-out 0.6s infinite"></div>
      ...
      <div data-band="4" data-par="0.26" style="position:absolute; left:0; top:0; width:6400px; height:810px; color:#000105; pointer-events:none">
        <svg viewBox="0 0 6400 810" preserveAspectRatio="none" style="position:absolute; left:0; top:0; width:6400px; height:810px">
      ...
      <div data-moonlight="1" style="position:absolute; left:1200px; top:414px; width:1900px; height:1500px; transform:translate(-50%,-50%); background:radial-gradient(ellipse at center,rgba(174,202,255,.3) 0%,rgba(150,184,255,.14) 26%,rgba(130,168,250,.05) 48%,rgba(120,160,250,0) 70%); pointer-events:none"></div>

...
export const AUDIO_MANIFEST = [
  ...
  { key: 'sfx.boy_crying', bus: 'sfx', loop: false, seconds: 8.25, channels: 1, file: 'sfx/boy_crying', format: 'mp3', fallback: null, available: true, purpose: 'soft crying/sniffles — Joseph alone at the bottom of the pit (short mono one-shot)', scene: 'joseph3d-1' },
